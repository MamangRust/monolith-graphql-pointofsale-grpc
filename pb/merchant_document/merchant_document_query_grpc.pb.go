...
const (
	MerchantDocumentQueryService_FindAll_FullMethodName       = "/pb.merchant_document.Merchant_documentQueryService/FindAll"
	MerchantDocumentQueryService_FindAllActive_FullMethodName = "/pb.merchant_document.Merchant_documentQueryService/FindAllActive"
	MerchantDocumentQueryService_FindById_FullMethodName      = "/pb.merchant_document.Merchant_documentQueryService/FindById"
)
...
func RegisterMerchantDocumentQueryServiceServer(s grpc.ServiceRegistrar, srv MerchantDocumentQueryServiceServer) {
	// If the following call panics, it indicates UnimplementedMerchantDocumentQueryServiceServer was
...
var MerchantDocumentQueryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.merchant_document.Merchant_documentQueryService",
