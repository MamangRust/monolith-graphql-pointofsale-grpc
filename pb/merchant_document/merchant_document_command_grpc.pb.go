...
const (
	MerchantDocumentCommandService_FindAllTrashed_FullMethodName     = "/pb.merchant_document.Merchant_documentCommandService/FindAllTrashed"
	MerchantDocumentCommandService_Create_FullMethodName             = "/pb.merchant_document.Merchant_documentCommandService/Create"
	MerchantDocumentCommandService_Update_FullMethodName             = "/pb.merchant_document.Merchant_documentCommandService/Update"
	MerchantDocumentCommandService_UpdateStatus_FullMethodName       = "/pb.merchant_document.Merchant_documentCommandService/UpdateStatus"
	MerchantDocumentCommandService_Trashed_FullMethodName            = "/pb.merchant_document.Merchant_documentCommandService/Trashed"
	MerchantDocumentCommandService_Restore_FullMethodName            = "/pb.merchant_document.Merchant_documentCommandService/Restore"
	MerchantDocumentCommandService_DeletePermanent_FullMethodName    = "/pb.merchant_document.Merchant_documentCommandService/DeletePermanent"
	MerchantDocumentCommandService_RestoreAll_FullMethodName         = "/pb.merchant_document.Merchant_documentCommandService/RestoreAll"
	MerchantDocumentCommandService_DeleteAllPermanent_FullMethodName = "/pb.merchant_document.Merchant_documentCommandService/DeleteAllPermanent"
)
...
func (c *merchantDocumentCommandServiceClient) FindAllTrashed(ctx context.Context, in *FindAllMerchantDocumentsRequest, opts ...grpc.CallOption) (*ApiResponsePaginationMerchantDocumentAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponsePaginationMerchantDocumentAt)
	err := c.cc.Invoke(ctx, MerchantDocumentCommandService_FindAllTrashed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMerchantDocumentCommandServiceServer) FindAllTrashed(context.Context, *FindAllMerchantDocumentsRequest) (*ApiResponsePaginationMerchantDocumentAt, error) {
...
func RegisterMerchantDocumentCommandServiceServer(s grpc.ServiceRegistrar, srv MerchantDocumentCommandServiceServer) {
	// If the following call panics, it indicates UnimplementedMerchantDocumentCommandServiceServer was
...
func _MerchantDocumentCommandService_FindAllTrashed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindAllMerchantDocumentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MerchantDocumentCommandServiceServer).FindAllTrashed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantDocumentCommandService_FindAllTrashed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MerchantDocumentCommandServiceServer).FindAllTrashed(ctx, req.(*FindAllMerchantDocumentsRequest))
	}
...
var MerchantDocumentCommandService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.merchant_document.Merchant_documentCommandService",
	HandlerType: (*MerchantDocumentCommandServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindAllTrashed",
			Handler:    _MerchantDocumentCommandService_FindAllTrashed_Handler,
		},
		{
			MethodName: "Create",
