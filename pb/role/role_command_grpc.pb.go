...
const (
	RoleCommandService_FindByTrashed_FullMethodName          = "/pb.role.RoleCommandService/FindByTrashed"
...
func (c *roleCommandServiceClient) FindByTrashed(ctx context.Context, in *FindAllRoleRequest, opts ...grpc.CallOption) (*ApiResponsePaginationRoleDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponsePaginationRoleDeleteAt)
	err := c.cc.Invoke(ctx, RoleCommandService_FindByTrashed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRoleCommandServiceServer) FindByTrashed(context.Context, *FindAllRoleRequest) (*ApiResponsePaginationRoleDeleteAt, error) {
...
func _RoleCommandService_FindByTrashed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindAllRoleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoleCommandServiceServer).FindByTrashed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoleCommandService_FindByTrashed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleCommandServiceServer).FindByTrashed(ctx, req.(*FindAllRoleRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RoleCommandService_FindByTrashed_Handler,
		},
		{
