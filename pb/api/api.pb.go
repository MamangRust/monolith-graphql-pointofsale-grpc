...
const file_api_api_proto_rawDesc = "" +
	"\n" +
	"\rapi/api.proto\x12\x06pb.api\"\x96\x01\n" +
	...
	"\x04code\x18\x03 \x01(\x05R\x04codeB;Z9github.com/MamangRust/monolith-graphql-pointofsale-pb/apib\x06proto3"
...
var file_api_api_proto_goTypes = []any{
	(*PaginationMeta)(nil), // 0: pb.api.PaginationMeta
	(*ErrorResponse)(nil),  // 1: pb.api.ErrorResponse
}
