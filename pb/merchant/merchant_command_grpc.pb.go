...
const (
	MerchantCommandService_FindByTrashed_FullMethodName              = "/pb.merchant.MerchantCommandService/FindByTrashed"
	MerchantCommandService_Create_FullMethodName                     = "/pb.merchant.MerchantCommandService/Create"
	MerchantCommandService_Update_FullMethodName                     = "/pb.merchant.MerchantCommandService/Update"
...
func (c *merchantCommandServiceClient) FindByTrashed(ctx context.Context, in *FindAllMerchantRequest, opts ...grpc.CallOption) (*ApiResponsePaginationMerchantDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponsePaginationMerchantDeleteAt)
	err := c.cc.Invoke(ctx, MerchantCommandService_FindByTrashed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMerchantCommandServiceServer) FindByTrashed(context.Context, *FindAllMerchantRequest) (*ApiResponsePaginationMerchantDeleteAt, error) {
...
func RegisterMerchantCommandServiceServer(s grpc.ServiceRegistrar, srv MerchantCommandServiceServer) {
	// If the following call panics, it indicates UnimplementedMerchantCommandServiceServer was
...
func _MerchantCommandService_FindByTrashed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindAllMerchantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MerchantCommandServiceServer).FindByTrashed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantCommandService_FindByTrashed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MerchantCommandServiceServer).FindByTrashed(ctx, req.(*FindAllMerchantRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MerchantCommandService_FindByTrashed_Handler,
		},
		{
			MethodName: "Create",
