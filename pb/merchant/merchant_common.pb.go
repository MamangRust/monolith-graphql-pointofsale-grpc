...
func (x *ApiResponseMerchantDelete) Reset() {
	*x = ApiResponseMerchantDelete{}
	mi := &file_merchant_merchant_common_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponseMerchantDelete) Descriptor() ([]byte, []int) {
	return file_merchant_merchant_common_proto_rawDescGZIP(), []int{10}
}
...
func (x *ApiResponseMerchantAll) Reset() {
	*x = ApiResponseMerchantAll{}
	mi := &file_merchant_merchant_common_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponseMerchantAll) Descriptor() ([]byte, []int) {
	return file_merchant_merchant_common_proto_rawDescGZIP(), []int{11}
}
...
func (x *ApiResponsePaginationMerchantDeleteAt) Reset() {
	*x = ApiResponsePaginationMerchantDeleteAt{}
	mi := &file_merchant_merchant_common_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponsePaginationMerchantDeleteAt) Descriptor() ([]byte, []int) {
	return file_merchant_merchant_common_proto_rawDescGZIP(), []int{12}
}
...
func (x *ApiResponsePaginationMerchant) Reset() {
	*x = ApiResponsePaginationMerchant{}
	mi := &file_merchant_merchant_common_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApiResponsePaginationMerchant) Descriptor() ([]byte, []int) {
	return file_merchant_merchant_common_proto_rawDescGZIP(), []int{13}
}
...
const file_merchant_merchant_common_proto_rawDesc = "" +
	"\n" +
	"\x1emerchant/merchant_common.proto\x12\vpb.merchant\x1a\x10common/api.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\"a\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x129\n" +
	"\x04data\x18\x03 \x03(\v2%.pb.merchant.MerchantResponseDeleteAtR\x04data\x129\n" +
	"\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x121\n" +
	"\x04data\x18\x03 \x03(\v2\x1d.pb.merchant.MerchantResponseR\x04data\x129\n" +
	"\n" +
	"pagination\x18\x04 \x01(\v2\x19.pb.common.PaginationMetaR\n" +
	"paginationB@Z>github.com/MamangRust/monolith-graphql-pointofsale-pb/merchantb\x06proto3"
...
var file_merchant_merchant_common_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
