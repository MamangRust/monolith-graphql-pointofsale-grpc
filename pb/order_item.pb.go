...
package monolith_graphql_pointofsale_pb
...
const file_order_item_proto_rawDesc = "" +
	"\n" +
	"\x10order_item.proto\x12\x02pb\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x10common/api.proto\"b\n" +
	...
	"\x04data\x18\x03 \x03(\v2\x1d.pb.OrderItemResponseDeleteAtR\x04data\x129\n" +
	"\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12)\n" +
	"\x04data\x18\x03 \x03(\v2\x15.pb.OrderItemResponseR\x04data\x129\n" +
	"\n" +
	"pagination\x18\x04 \x01(\v2\x19.pb.common.PaginationMetaR\n" +
	"pagination2\xe2\x02\n" +
	...
	"\x14FindOrderItemByOrder\x12\x1c.pb.FindByIdOrderItemRequest\x1a\x19.pb.ApiResponsesOrderItemB7Z5github.com/MamangRust/monolith-graphql-pointofsale-pbb\x06proto3"
...
var file_order_item_proto_depIdxs = []int32{
	...
	11, // 4: pb.ApiResponsePaginationOrderItemDeleteAt.pagination:type_name -> pb.common.PaginationMeta
	2,  // 5: pb.ApiResponsePaginationOrderItem.data:type_name -> pb.OrderItemResponse
	11, // 6: pb.ApiResponsePaginationOrderItem.pagination:type_name -> pb.common.PaginationMeta
