...
const (
	TransactionCommandService_FindByTrashed_FullMethodName                 = "/pb.transaction.TransactionCommandService/FindByTrashed"
	TransactionCommandService_Create_FullMethodName                        = "/pb.transaction.TransactionCommandService/Create"
	TransactionCommandService_Update_FullMethodName                        = "/pb.transaction.TransactionCommandService/Update"
...
func (c *transactionCommandServiceClient) FindByTrashed(ctx context.Context, in *FindAllTransactionRequest, opts ...grpc.CallOption) (*ApiResponsePaginationTransactionDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponsePaginationTransactionDeleteAt)
	err := c.cc.Invoke(ctx, TransactionCommandService_FindByTrashed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTransactionCommandServiceServer) FindByTrashed(context.Context, *FindAllTransactionRequest) (*ApiResponsePaginationTransactionDeleteAt, error) {
...
func _TransactionCommandService_FindByTrashed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindAllTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).FindByTrashed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_FindByTrashed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).FindByTrashed(ctx, req.(*FindAllTransactionRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TransactionCommandService_FindByTrashed_Handler,
		},
		{
			MethodName: "Create",
