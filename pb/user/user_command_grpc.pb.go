...
const (
	UserCommandService_FindByTrashed_FullMethodName          = "/pb.user.UserCommandService/FindByTrashed"
...
func (c *userCommandServiceClient) FindByTrashed(ctx context.Context, in *FindAllUserRequest, opts ...grpc.CallOption) (*ApiResponsePaginationUserDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponsePaginationUserDeleteAt)
	err := c.cc.Invoke(ctx, UserCommandService_FindByTrashed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserCommandServiceServer) FindByTrashed(context.Context, *FindAllUserRequest) (*ApiResponsePaginationUserDeleteAt, error) {
...
func _UserCommandService_FindByTrashed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindAllUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCommandServiceServer).FindByTrashed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCommandService_FindByTrashed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCommandServiceServer).FindByTrashed(ctx, req.(*FindAllUserRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _UserCommandService_FindByTrashed_Handler,
		},
		{
			MethodName: "Create",
