...
func (s *merchantDocumentHandleGrpc) FindAll(ctx context.Context, req *pbmerchant_document.FindAllMerchantDocumentsRequest) (*pbmerchant_document.ApiResponsePaginationMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) FindById(ctx context.Context, req *pbmerchant_document.FindMerchantDocumentByIdRequest) (*pbmerchant_document.ApiResponseMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) FindAllActive(ctx context.Context, req *pbmerchant_document.FindAllMerchantDocumentsRequest) (*pbmerchant_document.ApiResponsePaginationMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) FindAllTrashed(ctx context.Context, req *pbmerchant_document.FindAllMerchantDocumentsRequest) (*pbmerchant_document.ApiResponsePaginationMerchantDocumentAt, error) {
...
func (s *merchantDocumentHandleGrpc) Create(ctx context.Context, req *pbmerchant_document.CreateMerchantDocumentRequest) (*pbmerchant_document.ApiResponseMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) Update(ctx context.Context, req *pbmerchant_document.UpdateMerchantDocumentRequest) (*pbmerchant_document.ApiResponseMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) UpdateStatus(ctx context.Context, req *pbmerchant_document.UpdateMerchantDocumentStatusRequest) (*pbmerchant_document.ApiResponseMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) Trashed(ctx context.Context, req *pbmerchant_document.TrashedMerchantDocumentRequest) (*pbmerchant_document.ApiResponseMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) Restore(ctx context.Context, req *pbmerchant_document.RestoreMerchantDocumentRequest) (*pbmerchant_document.ApiResponseMerchantDocument, error) {
...
func (s *merchantDocumentHandleGrpc) DeletePermanent(ctx context.Context, req *pbmerchant_document.DeleteMerchantDocumentPermanentRequest) (*pbmerchant_document.ApiResponseMerchantDocumentDelete, error) {
...
func (s *merchantDocumentHandleGrpc) RestoreAll(ctx context.Context, _ *emptypb.Empty) (*pbmerchant_document.ApiResponseMerchantDocumentAll, error) {
...
func (s *merchantDocumentHandleGrpc) DeleteAllPermanent(ctx context.Context, _ *emptypb.Empty) (*pbmerchant_document.ApiResponseMerchantDocumentAll, error) {
...
// Map helpers
func mapMerchantDocument(doc *db.MerchantDocument) *pbmerchant_document.MerchantDocument {
	if doc == nil {
		return nil
	}
...
func mapResponsesGetMerchantDocumentsRow(docs []*db.GetMerchantDocumentsRow) []*pbmerchant_document.MerchantDocument {
	var res []*pbmerchant_document.MerchantDocument
	for _, doc := range docs {
		res = append(res, &pbmerchant_document.MerchantDocument{
			DocumentId:   int32(doc.DocumentID),
			MerchantId:   int32(doc.MerchantID),
			DocumentType: doc.DocumentType,
			DocumentUrl:  doc.DocumentUrl,
...
func mapResponsesGetActiveMerchantDocumentsRow(docs []*db.GetActiveMerchantDocumentsRow) []*pbmerchant_document.MerchantDocument {
	var res []*pbmerchant_document.MerchantDocument
	for _, doc := range docs {
		res = append(res, &pbmerchant_document.MerchantDocument{
			DocumentId:   int32(doc.DocumentID),
...
func mapMerchantDocumentDeleteAt(doc *db.MerchantDocument) *pbmerchant_document.MerchantDocumentDeleteAt {
	if doc == nil {
		return nil
	}
...
func mapResponsesGetTrashedMerchantDocumentsRow(docs []*db.GetTrashedMerchantDocumentsRow) []*pbmerchant_document.MerchantDocumentDeleteAt {
	...
	for _, doc := range docs {
		...
		res = append(res, &pbmerchant_document.MerchantDocumentDeleteAt{
			DocumentId:   int32(doc.DocumentID),
			MerchantId:   int32(doc.MerchantID),
			DocumentType: doc.DocumentType,
			DocumentUrl:  doc.DocumentUrl,
