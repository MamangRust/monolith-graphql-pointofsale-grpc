...
func NewServer(cfg *server.Config) (*server.GRPCServer, error) {
	...
	srv.RegisterServices = func(gs *grpc.Server) {
		...
		pb.RegisterMerchantQueryServiceServer(gs, handlers.MerchantQuery)
		pbdocument.RegisterMerchantDocumentCommandServiceServer(gs, handlers.MerchantDocumentCommand)
		pbdocument.RegisterMerchantDocumentQueryServiceServer(gs, handlers.MerchantDocumentQuery)
	}
