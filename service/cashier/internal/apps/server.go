...
func NewServer(cfg *server.Config) (*server.GRPCServer, error) {
	...
	userClient := userpb.NewUserQueryServiceClient(userConn)
	...
	srv.RegisterServices = func(gs *grpc.Server) {
		pb.RegisterCashierQueryServiceServer(gs, handlers.Query)
		pb.RegisterCashierCommandServiceServer(gs, handlers.Command)
		pb.RegisterCashierStatsServiceServer(gs, handlers.Stats)
	}
