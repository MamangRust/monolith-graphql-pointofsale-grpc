...
func (s *orderHandleGrpc) FindAll(ctx context.Context, request *pborder.FindAllOrderRequest) (*pborder.ApiResponsePaginationOrder, error) {
...
func (s *orderHandleGrpc) FindByMerchant(ctx context.Context, request *pborder.FindAllOrderMerchantRequest) (*pborder.ApiResponsePaginationOrder, error) {
	s.logger.Info("FindByMerchant orders called", zap.Int32("merchant_id", request.GetMerchantId()))
	...
	if err != nil {
		s.logger.Error("FindByMerchant orders failed", zap.Error(err))
		return nil, errors.ToGrpcError(err)
	}
	...
	s.logger.Info("FindByMerchant orders success")

	return &pborder.ApiResponsePaginationOrder{
		Status:     "success",
		Message:    "Successfully fetched order",
		Data:       mapResponsesOrderByMerchant(orders),
		Pagination: mapPaginationMeta(paginationMeta),
	}, nil
}

func (s *orderHandleGrpc) FindById(ctx context.Context, request *pborder.FindByIdOrderRequest) (*pborder.ApiResponseOrder, error) {
...
func (s *orderHandleGrpc) FindByActive(ctx context.Context, request *pborder.FindAllOrderRequest) (*pborder.ApiResponsePaginationOrderDeleteAt, error) {
...
func (s *orderHandleGrpc) FindByTrashed(ctx context.Context, request *pborder.FindAllOrderRequest) (*pborder.ApiResponsePaginationOrderDeleteAt, error) {
...
func (s *orderHandleGrpc) FindMonthlyTotalRevenue(ctx context.Context, req *pborder.FindYearMonthTotalRevenue) (*pborder.ApiResponseOrderMonthlyTotalRevenue, error) {
...
func (s *orderHandleGrpc) FindYearlyTotalRevenue(ctx context.Context, req *pborder.FindYearTotalRevenue) (*pborder.ApiResponseOrderYearlyTotalRevenue, error) {
...
func (s *orderHandleGrpc) FindMonthlyTotalRevenueById(ctx context.Context, req *pborder.FindYearMonthTotalRevenueById) (*pborder.ApiResponseOrderMonthlyTotalRevenue, error) {
	s.logger.Info("FindMonthlyTotalRevenueById orders called", zap.Int32("orderId", req.GetOrderId()))
	...
	methods, err := s.orderStats.FindMonthlyTotalRevenueById(ctx, &reqService)
	if err != nil {
		s.logger.Error("FindMonthlyTotalRevenueById orders failed", zap.Error(err))
		return nil, errors.ToGrpcError(err)
	}

	s.logger.Info("FindMonthlyTotalRevenueById orders success")

	return &pborder.ApiResponseOrderMonthlyTotalRevenue{
		Status:  "success",
		Message: "Monthly sales retrieved successfully",
		Data:    mapResponseOrderMonthlyTotalRevenuesById(methods),
	}, nil
}

func (s *orderHandleGrpc) FindYearlyTotalRevenueById(ctx context.Context, req *pborder.FindYearTotalRevenueById) (*pborder.ApiResponseOrderYearlyTotalRevenue, error) {
	s.logger.Info("FindYearlyTotalRevenueById orders called", zap.Int32("orderId", req.GetOrderId()))
	...
	methods, err := s.orderStats.FindYearlyTotalRevenueById(ctx, &reqService)
	if err != nil {
		s.logger.Error("FindYearlyTotalRevenueById orders failed", zap.Error(err))
		return nil, errors.ToGrpcError(err)
	}

	s.logger.Info("FindYearlyTotalRevenueById orders success")

	return &pborder.ApiResponseOrderYearlyTotalRevenue{
		Status:  "success",
		Message: "Yearly payment methods retrieved successfully",
		Data:    mapResponseOrderYearlyTotalRevenuesById(methods),
	}, nil
}

func (s *orderHandleGrpc) FindMonthlyTotalRevenueByMerchant(ctx context.Context, req *pborder.FindYearMonthTotalRevenueByMerchant) (*pborder.ApiResponseOrderMonthlyTotalRevenue, error) {
...
func (s *orderHandleGrpc) FindYearlyTotalRevenueByMerchant(ctx context.Context, req *pborder.FindYearTotalRevenueByMerchant) (*pborder.ApiResponseOrderYearlyTotalRevenue, error) {
...
func (s *orderHandleGrpc) FindMonthlyRevenue(ctx context.Context, request *pborder.FindYearOrder) (*pborder.ApiResponseOrderMonthly, error) {
...
func (s *orderHandleGrpc) FindYearlyRevenue(ctx context.Context, request *pborder.FindYearOrder) (*pborder.ApiResponseOrderYearly, error) {
...
func (s *orderHandleGrpc) FindMonthlyRevenueByMerchant(ctx context.Context, request *pborder.FindYearOrderByMerchant) (*pborder.ApiResponseOrderMonthly, error) {
...
func (s *orderHandleGrpc) FindYearlyRevenueByMerchant(ctx context.Context, request *pborder.FindYearOrderByMerchant) (*pborder.ApiResponseOrderYearly, error) {
...
func (s *orderHandleGrpc) Create(ctx context.Context, request *pborder.CreateOrderRequest) (*pborder.ApiResponseOrder, error) {
...
func (s *orderHandleGrpc) Update(ctx context.Context, request *pborder.UpdateOrderRequest) (*pborder.ApiResponseOrder, error) {
...
func (s *orderHandleGrpc) TrashedOrder(ctx context.Context, request *pborder.FindByIdOrderRequest) (*pborder.ApiResponseOrderDeleteAt, error) {
...
func (s *orderHandleGrpc) RestoreOrder(ctx context.Context, request *pborder.FindByIdOrderRequest) (*pborder.ApiResponseOrderDeleteAt, error) {
...
func (s *orderHandleGrpc) DeleteOrderPermanent(ctx context.Context, request *pborder.FindByIdOrderRequest) (*pborder.ApiResponseOrderDelete, error) {
...
func (s *orderHandleGrpc) RestoreAllOrder(ctx context.Context, _ *emptypb.Empty) (*pborder.ApiResponseOrderAll, error) {
...
func (s *orderHandleGrpc) DeleteAllOrderPermanent(ctx context.Context, _ *emptypb.Empty) (*pborder.ApiResponseOrderAll, error) {
...
func mapResponseOrder(order *db.Order) *pborder.OrderResponse {
	if order == nil {
		return nil
	}
...
func mapResponsesOrderByMerchant(orders []*db.GetOrdersByMerchantRow) []*pborder.OrderResponse {
	var mappedOrders []*pborder.OrderResponse
	for _, order := range orders {
		if order == nil {
			continue
		}
		mappedOrders = append(mappedOrders, &pborder.OrderResponse{
			Id:         order.OrderID,
...
func mapResponsesOrder(orders []*db.GetOrdersRow) []*pborder.OrderResponse {
	var mappedOrders []*pborder.OrderResponse
	for _, order := range orders {
		if order == nil {
			continue
...
func mapResponseOrderDeleteAt(order *db.Order) *pborder.OrderResponseDeleteAt {
	if order == nil {
		return nil
	}
...
func mapResponsesOrderActive(orders []*db.GetOrdersActiveRow) []*pborder.OrderResponseDeleteAt {
	...
	for _, order := range orders {
		...
		mappedOrders = append(mappedOrders, &pborder.OrderResponseDeleteAt{
			Id:         int32(order.OrderID),
			MerchantId: int32(order.MerchantID),
			CashierId:  int32(order.CashierID),
			TotalPrice: int32(order.TotalPrice),
...
func mapResponsesOrderTrashed(orders []*db.GetOrdersTrashedRow) []*pborder.OrderResponseDeleteAt {
	var mappedOrders []*pborder.OrderResponseDeleteAt
	for _, order := range orders {
		if order == nil {
			continue
...
func mapResponseOrderMonthlyTotalRevenue(row *db.GetMonthlyTotalRevenueRow) *pborder.OrderMonthlyTotalRevenueResponse {
	if row == nil {
		return nil
	}
...
func mapResponseOrderMonthlyTotalRevenues(c []*db.GetMonthlyTotalRevenueRow) []*pborder.OrderMonthlyTotalRevenueResponse {
...
func mapResponseOrderMonthlyTotalRevenueByMerchant(row *db.GetMonthlyTotalRevenueByMerchantRow) *pborder.OrderMonthlyTotalRevenueResponse {
	if row == nil {
		return nil
	}
	return &pborder.OrderMonthlyTotalRevenueResponse{
...
func mapResponseOrderMonthlyTotalRevenuesByMerchant(c []*db.GetMonthlyTotalRevenueByMerchantRow) []*pborder.OrderMonthlyTotalRevenueResponse {
	var orderRecords []*pborder.OrderMonthlyTotalRevenueResponse
	for _, row := range c {
...
func mapResponseOrderMonthlyTotalRevenueById(row *db.GetMonthlyTotalRevenueByIdRow) *pborder.OrderMonthlyTotalRevenueResponse {
	if row == nil {
		return nil
	}
	return &pborder.OrderMonthlyTotalRevenueResponse{
...
func mapResponseOrderMonthlyTotalRevenuesById(c []*db.GetMonthlyTotalRevenueByIdRow) []*pborder.OrderMonthlyTotalRevenueResponse {
	var orderRecords []*pborder.OrderMonthlyTotalRevenueResponse
	for _, row := range c {
		orderRecords = append(orderRecords, mapResponseOrderMonthlyTotalRevenueById(row))
	}
	return orderRecords
}

func mapResponseOrderYearlyTotalRevenue(row *db.GetYearlyTotalRevenueRow) *pborder.OrderYearlyTotalRevenueResponse {
	if row == nil {
		return nil
	}
...
func mapResponseOrderYearlyTotalRevenues(c []*db.GetYearlyTotalRevenueRow) []*pborder.OrderYearlyTotalRevenueResponse {
...
func mapResponseOrderYearlyTotalRevenueByMerchant(row *db.GetYearlyTotalRevenueByMerchantRow) *pborder.OrderYearlyTotalRevenueResponse {
	if row == nil {
		return nil
	}
	return &pborder.OrderYearlyTotalRevenueResponse{
...
func mapResponseOrderYearlyTotalRevenuesByMerchant(c []*db.GetYearlyTotalRevenueByMerchantRow) []*pborder.OrderYearlyTotalRevenueResponse {
	var orderRecords []*pborder.OrderYearlyTotalRevenueResponse
	for _, row := range c {
...
func mapResponseOrderYearlyTotalRevenueById(row *db.GetYearlyTotalRevenueByIdRow) *pborder.OrderYearlyTotalRevenueResponse {
	if row == nil {
		return nil
	}
	return &pborder.OrderYearlyTotalRevenueResponse{
...
func mapResponseOrderYearlyTotalRevenuesById(c []*db.GetYearlyTotalRevenueByIdRow) []*pborder.OrderYearlyTotalRevenueResponse {
	var orderRecords []*pborder.OrderYearlyTotalRevenueResponse
	for _, row := range c {
		orderRecords = append(orderRecords, mapResponseOrderYearlyTotalRevenueById(row))
	}
	return orderRecords
}

func mapResponsesOrderMonthlyPrices(c []*db.GetMonthlyOrderRow) []*pborder.OrderMonthlyResponse {
	var categoryRecords []*pborder.OrderMonthlyResponse
	for _, category := range c {
		if category == nil {
			continue
		}
		categoryRecords = append(categoryRecords, &pborder.OrderMonthlyResponse{
...
func mapResponsesOrderMonthlyPricesByMerchant(c []*db.GetMonthlyOrderByMerchantRow) []*pborder.OrderMonthlyResponse {
	var categoryRecords []*pborder.OrderMonthlyResponse
	for _, category := range c {
		if category == nil {
			continue
...
func mapResponsesOrderYearlyPrices(c []*db.GetYearlyOrderRow) []*pborder.OrderYearlyResponse {
	var categoryRecords []*pborder.OrderYearlyResponse
	for _, category := range c {
		if category == nil {
			continue
		}
		categoryRecords = append(categoryRecords, &pborder.OrderYearlyResponse{
			Year:               category.Year,
			OrderCount:         int32(category.OrderCount),
			TotalRevenue:       int32(category.TotalRevenue),
			TotalItemsSold:     int32(category.TotalItemsSold),
...
func mapResponsesOrderYearlyPricesByMerchant(c []*db.GetYearlyOrderByMerchantRow) []*pborder.OrderYearlyResponse {
	var categoryRecords []*pborder.OrderYearlyResponse
	for _, category := range c {
		if category == nil {
			continue
