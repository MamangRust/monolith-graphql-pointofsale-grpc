module github.com/MamangRust/monolith-graphql-pointofsale-order-item

go 1.25.0

require (
	github.com/MamangRust/monolith-graphql-pointofsale-pb v0.0.0-00010101000000-000000000000
	github.com/MamangRust/monolith-graphql-pointofsale-pkg v1.0.7
	github.com/MamangRust/monolith-graphql-pointofsale-shared v1.0.8
