...
func (p *productProtoMapper) ToProtoResponsePaginationProductDeleteAt(pagination *pbutils.PaginationMeta, status string, message string, products []*response.ProductResponseDeleteAt) *pb.ApiResponsePaginationProductDeleteAt {
...
func (p *productProtoMapper) ToProtoResponsePaginationProduct(pagination *pbutils.PaginationMeta, status string, message string, products []*response.ProductResponse) *pb.ApiResponsePaginationProduct {
